module github.com/deckhouse/sds-node-configurator/images/drbd-cluster-sync

go 1.24.2

require (
	github.com/LINBIT/golinstor v0.52.2
	github.com/deckhouse/sds-replicated-volume/api v0.0.0-20250129113300-011ced0b3789
