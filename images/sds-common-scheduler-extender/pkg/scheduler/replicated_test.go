...
func TestScoreNodes_MultiVolume_ReplicaIntersection(t *testing.T) {
	...
	pvA := testPV("pv-a", "rv-a")
	rvA := testRV("rv-a", []srv.DatameshMember{diskfulMember("node-1"), diskfulMember("node-2")})

	// Vol B: replicas on node-2 and node-3
	pvcB := testBoundPVC("pvc-b", "default", scName, "pv-b")
	pvB := testPV("pv-b", "rv-b")
	rvB := testRV("rv-b", []srv.DatameshMember{diskfulMember("node-2"), diskfulMember("node-3")})
...
func TestScoreNodes_MultiVolume_AllReplicasOnAllNodes(t *testing.T) {
	...
	pvcB := testBoundPVC("pvc-b", "default", scName, "pv-b")
	pvB := testPV("pv-b", "rv-b")
	rvB := testRV("rv-b", []srv.DatameshMember{diskfulMember("node-1"), diskfulMember("node-2")})
...
func TestScoreNodes_ThreeVolumes_PartialOverlap(t *testing.T) {
	...
	pvcA := testBoundPVC("pvc-a", "default", scName, "pv-a")
	pvA := testPV("pv-a", "rv-a")
	rvA := testRV("rv-a", []srv.DatameshMember{diskfulMember("node-1"), diskfulMember("node-2"), diskfulMember("node-3")})
	...
	pvC := testPV("pv-c", "rv-c")
	rvC := testRV("rv-c", []srv.DatameshMember{diskfulMember("node-1")})
...
func TestScoreNodes_MixedLocalThickAndReplicated_SameLVG(t *testing.T) {
	...
	pvRepl := testPV("pv-repl", "rv1")
	rv := testRV("rv1", []srv.DatameshMember{diskfulMember("node-1")})
...
func TestScoreNodes_MixedLocalAndReplicated_DifferentLVGs(t *testing.T) {
	...
	replPVC := testBoundPVC("pvc-repl", "default", replSCName, "pv-repl")
	pvRepl := testPV("pv-repl", "rv1")
	rv := testRV("rv1", []srv.DatameshMember{diskfulMember("node-2")})
...
func TestScoreNodes_MixedVolumeAccess_LocalAndAny(t *testing.T) {
	...
	pvLocal := testPV("pv-local-va", "rv-local")
	rvLocal := testRV("rv-local", []srv.DatameshMember{diskfulMember("node-1"), diskfulMember("node-2")})

	anyPVC := testBoundPVC("pvc-any-va", "default", anySCName, "pv-any-va")
	pvAny := testPV("pv-any-va", "rv-any")
	rvAny := testRV("rv-any", []srv.DatameshMember{diskfulMember("node-1")})
