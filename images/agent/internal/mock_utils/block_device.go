...
// Source: block_device.go
//
// Generated by this command:
//
//	mockgen -copyright_file ../../../../hack/boilerplate.mockgen.txt -write_source_comment -destination=../mock_utils/block_device.go -source=block_device.go
//
