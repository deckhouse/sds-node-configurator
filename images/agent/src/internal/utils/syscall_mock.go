...
// Source: internal/utils/syscall.go
//
// Generated by this command:
//
//	mockgen -source=internal/utils/syscall.go -self_package agent/internal/utils -package utils -write_generate_directive
//
...
//go:generate mockgen -source=internal/utils/syscall.go -self_package agent/internal/utils -package utils -write_generate_directive
...
func (m *MockSysCall) Fstat(fd int, stat *Stat_t) error {
	m.ctrl.T.Helper()
...
func (m *MockSysCall) Syscall(trap, a1, a2, a3 uintptr) (uintptr, uintptr, Errno) {
	m.ctrl.T.Helper()
