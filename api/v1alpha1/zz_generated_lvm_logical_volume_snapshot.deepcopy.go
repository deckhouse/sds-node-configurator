...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LVMLogicalVolumeSnapshotSource) DeepCopyInto(out *LVMLogicalVolumeSnapshotSource) {
	*out = *in
	if in.Selector != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LVMLogicalVolumeSnapshotSource.
func (in *LVMLogicalVolumeSnapshotSource) DeepCopy() *LVMLogicalVolumeSnapshotSource {
	if in == nil {
		return nil
	}
	out := new(LVMLogicalVolumeSnapshotSource)
	in.DeepCopyInto(out)
	return out
}
